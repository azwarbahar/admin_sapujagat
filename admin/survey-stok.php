        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <h4 class="page-title">Survey Stok</h4>
                    <ol class="breadcrumb">
                        <li>
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            foreach ($produk_all_operator_telkomsel as $dta_produk_all_operator_telkomsel) {
                                                echo "<th>$dta_produk_all_operator_telkomsel[nama_produk]</th>";
                                            }
                                            ?>
                                            <th>Salesforce</th>
                                        </tr>
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($result_outlet as $dta) { ?>
                                            <tr>
                                                ...
                                                $produk_kosong = mysqli_query($conn, "SELECT * FROM tb_survey_stok WHERE nama_produk = 'Perdana Kosong' AND
                                                ...
                                                if (mysqli_num_rows($produk_kosong) < 1) {
                                                    ...
                                                    echo "<td> $dta_produk_kosong[jumlah_produk] </td>";
                                                }
                                                foreach ($produk_all_operator_telkomsel as $dta_produk_all_operator_telkomsel) {
                                                    $produk = mysqli_query($conn, "SELECT * FROM tb_survey_stok WHERE produk_id = '$dta_produk_all_operator_telkomsel[id]' AND
                                                                                                kunjungan_id = '$dta_kunjungan[id]'AND
                                                                                                outlet_id = '$dta[id]'");
                                                    if (mysqli_num_rows($produk) < 1) {
                                                        ...
                                                        echo "<td> $dta_produk[jumlah_produk] </td>";
                                                    }
                                                }
