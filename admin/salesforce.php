                                ...
                                foreach ($sales as $dta) { ?>
                                    <tr>
                                        ...
                                        if ($dta['status'] == "Active") {
                                            echo "<td style='text-align: center;'><span class='label label-default'> Active </span></td>";
                                        } else {
                                            echo "<td style='text-align: center;'><span class='label label-danger'> Inactive </span></td>";
                                        }
                                        ?>
